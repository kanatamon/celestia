# Celestia — Codex agent instructions
...
apps/
  ...
  legacy/          ← READ-ONLY reference. Do not modify, lint, or type-check.
packages/
...
- `apps/legacy` is excluded from pnpm workspaces, Biome, and Turbo pipelines. Never modify it.
